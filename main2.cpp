...
#if 1 // I think this is old code.... but I'm unsure.  It *has* been almost 20 years!  Not old code.  this is how I tested the code before building the DLL for WinAmp
...
int main(void)
{
    ...
    MyDictionary<value_t*> dict; // ("x", &x, "y", &y);  // I have NO IDEA how this could have possibly compiled earlier...
