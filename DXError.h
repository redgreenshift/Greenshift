 ...
 ****************************************************************************/
 /*
  * used to figure out what in the world those error return values mean
  *
  * Blah blah blah, it's copied from the DX file so it's easier to use for me
  */
  /*
   * DXError
...
#endif  /* _DirectX_Error_Messages_H_ */
